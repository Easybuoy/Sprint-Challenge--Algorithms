class SortingRobot:
    ...
    def swap_item(self):
        ...
        """
        self._time += 1
        print(self._item, 'gbam0')
        print(self._list[self._position], 'gbam0')
        # Swap the held item with the list item at the robot's position
        self._item, self._list[self._position] = self._list[self._position], self._item
        print(self._item, 'gbam')
        print(self._list[self._position], 'gbam')
    ...
    def sort(self):
        ...
        # print('item', self.pickItem())
        # print(self._position)
        # # print(self.swap_item())
        # print(self.compare_item())
        # return
        while sorted(self._list) != self._list:
            self.pickItem()
